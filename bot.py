...
from telegram.ext import Application, CommandHandler, PollHandler, CallbackContext, JSONPersistence
...
async def create_and_send_poll(context: CallbackContext, chat_id: int):
    ...
    # Use context.bot_data for persistent storage
...
def main() -> None:
    ...
    # NEW: Set up persistence to save data to a file
